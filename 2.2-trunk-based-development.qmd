...
## Branching Patterns are not Set in Stone 🪨

- These are common patterns used in the industry
- You can (and should) adapt them to fit your needs
- Great resource to learn more: [Branching Patterns](https://martinfowler.com/articles/branching-patterns.html) by Martin Fowler
