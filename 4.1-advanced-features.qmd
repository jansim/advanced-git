...
A) Creating a Release
    1. Tag the latest commit in your copy of the website template repository
...
## *End of Section* 🎉 {background-color="black" background-opacity="0.2" background-image="images/backgrounds/kaiser.jpg"}
