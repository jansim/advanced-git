...
:::{.callout-note}
This document was orginially part of a course titled [Introduction to version Control in R with RStudio, Git, and GitHub](https://lmu-osc.github.io/Introduction-RStudio-Git-GitHub/).
