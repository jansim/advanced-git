---
title: "Advanced `git`"
subtitle: "Block 1.3: Branches, Merging & More"
...
# There's More to Branches than just Merging 🌲🌳🌴

## Worktrees 🌲🌳🌴

With git worktrees, you can have different different branches from one repository checked out *at the same time* — each in a different directory
...
## Practical: The Actual Conflict {background-color="black"}
...
[[⏩️ Next Section]](./1.4-filters_and_hooks.html) 
