...
Which of these git commands / actions are have you used already? Have you used any that are not on this list?
...
1. Create an ew directory called `git-example`
2. Create a new file `library.txt` in your `git-example` directory
3. Run `git init -h` and copy the output into your `library.txt`
...
- Demo!
- Feature: staging partial changes
