...
- `pre-commit`: Before commit is created ⭐️
...
- [🔗 Discussion of Pros and Cons](https://yeldirium.de/2025/10/09/pre-commit-hooks/index.html)
- [🔗 `hk`](https://hk.jdx.dev/): New alternative tool for managing git hooks
